    ...
    public class BossController : MonoBehaviour
    {
        ...
        IEnumerator CheckState()        //boss의 조건
        {
            while (!isDead)     //Boss가 살아있으면
            {
                ...
                if (range <= walkRange &&  currentState != CurrentState.ATTACK)
                {
        ...
        {
            int rndPercentage = Random.Range(1, 8);     //1~9 더함
        ...
        private void isAttack()
        {
                ...
                case 1:
                    ...
                    StartCoroutine(bossAttack.OnEnter(0.6f, BossAttack.eAttackType.ATTACK2));
                    break;
                case 2:
                    StartCoroutine(bossAttack.OnEnter(0, BossAttack.eAttackType.ATTACK3));
                    StartCoroutine(bossAttack.OnEnter(0.6f, BossAttack.eAttackType.ATTACK4));
                    break;
                case 3:
